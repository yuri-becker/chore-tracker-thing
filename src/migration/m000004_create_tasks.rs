...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Task::RecurrenceUnit)
                            .custom(RecurrenceUnit::Type)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Task::RecurrenceInterval)
                            .integer()
                            .not_null()
                            .check(Expr::col(Task::RecurrenceInterval).gte(1)),
                    )
                    .foreign_key(
                        ForeignKey::create()
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            ...
            .await?;
        manager
            .drop_type(Type::drop().name(RecurrenceUnit::Type).to_owned())
            .await
    }
}
